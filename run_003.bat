...
python latk_process_003.py -- %INPUT_DIR% %INPUT_EXT% %DIMS% %NUM_STROKES% %MIN_STROKE_SIZE% %MAX_STROKE_SIZE% %MAX_SIMILARITY%
...
rem python latk_process_006.py -- %INPUT_DIR% %INPUT_EXT% %NUM_CLUSTERS% %DIMS% %NUM_STROKES% %MIN_STROKE_SIZE% %MAX_STROKE_SIZE%
