...
rem echo
rem echo 3.2. Find edges in point clouds.
rem python Difference_Eigenvalues.py -- %OUTPUT_DIR% 

rem echo
rem echo 3.3. Transfer vertex color.
rem python color_transfer.py -- %INPUT_DIR% _resample_pre.ply %OUTPUT_DIR% _resample_fake_post_edges.ply _final.ply
